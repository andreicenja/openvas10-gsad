...
CMD ["gsad", "-f", "--listen=0.0.0.0", "--allow-header-host poke.eea.eu.int", "--rport=80", "--port=443", "--gnutls-priorities=SECURE128:-AES-128-CBC:-CAMELLIA-128-CBC:-VERS-SSL3.0:-VERS-TLS1.0", "--mlisten=$GVMD_HOST", "--mport=$GVMD_PORT"]
